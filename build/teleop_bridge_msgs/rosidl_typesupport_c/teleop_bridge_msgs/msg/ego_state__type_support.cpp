...
static const _EgoState_type_support_symbol_names_t _EgoState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_bridge_msgs, msg, EgoState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_bridge_msgs, msg, EgoState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_bridge_msgs, msg, EgoState)() {
  return &::teleop_bridge_msgs::msg::rosidl_typesupport_c::EgoState_message_type_support_handle;
}
