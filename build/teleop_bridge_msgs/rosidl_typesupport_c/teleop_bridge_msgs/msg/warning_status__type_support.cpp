...
static const _WarningStatus_type_support_symbol_names_t _WarningStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_bridge_msgs, msg, WarningStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_bridge_msgs, msg, WarningStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_bridge_msgs, msg, WarningStatus)() {
  return &::teleop_bridge_msgs::msg::rosidl_typesupport_c::WarningStatus_message_type_support_handle;
}
