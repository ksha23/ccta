...
#include "teleop_bridge_msgs/msg/detail/tracked_vehicle__rosidl_typesupport_fastrtps_c.h"
...
using _TrackedVehicle__ros_msg_type = teleop_bridge_msgs__msg__TrackedVehicle;
...
size_t get_serialized_size_teleop_bridge_msgs__msg__TrackedVehicle(
  ...
  size_t current_alignment)
{
  const _TrackedVehicle__ros_msg_type * ros_message = static_cast<const _TrackedVehicle__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_bridge_msgs__msg__TrackedVehicle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const teleop_bridge_msgs__msg__TrackedVehicle * ros_message = static_cast<const teleop_bridge_msgs__msg__TrackedVehicle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_teleop_bridge_msgs__msg__TrackedVehicle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  teleop_bridge_msgs__msg__TrackedVehicle * ros_message = static_cast<teleop_bridge_msgs__msg__TrackedVehicle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_teleop_bridge_msgs__msg__TrackedVehicle(cdr, ros_message);
}

static uint32_t _TrackedVehicle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_teleop_bridge_msgs__msg__TrackedVehicle(
...
static size_t _TrackedVehicle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_teleop_bridge_msgs__msg__TrackedVehicle(
...
static message_type_support_callbacks_t __callbacks_TrackedVehicle = {
...
static rosidl_message_type_support_t _TrackedVehicle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackedVehicle,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_bridge_msgs, msg, TrackedVehicle)() {
  return &_TrackedVehicle__type_support;
}
