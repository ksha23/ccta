...
#include "teleop_bridge_msgs/msg/detail/driver_input__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const teleop_bridge_msgs::msg::DriverInput & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_bridge_msgs::msg::DriverInput & ros_message)
{
  // Member: stamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_bridge_msgs
max_serialized_size_DriverInput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_bridge_msgs::msg::DriverInput;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_bridge_msgs
max_serialized_size_key_DriverInput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const teleop_bridge_msgs::msg::DriverInput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_bridge_msgs::msg::DriverInput *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DriverInput__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const teleop_bridge_msgs::msg::DriverInput *>(
...
static size_t _DriverInput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DriverInput(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DriverInput__callbacks = {
...
static rosidl_message_type_support_t _DriverInput__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DriverInput__callbacks,
...
{
  return &teleop_bridge_msgs::msg::typesupport_fastrtps_cpp::_DriverInput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_bridge_msgs, msg, DriverInput)() {
  return &teleop_bridge_msgs::msg::typesupport_fastrtps_cpp::_DriverInput__handle;
}
