...
#include "teleop_bridge_msgs/msg/detail/warning_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const teleop_bridge_msgs::msg::WarningStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_bridge_msgs::msg::WarningStatus & ros_message)
{
  // Member: stamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_bridge_msgs
max_serialized_size_WarningStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_bridge_msgs::msg::WarningStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_bridge_msgs
max_serialized_size_key_WarningStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const teleop_bridge_msgs::msg::WarningStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_bridge_msgs::msg::WarningStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WarningStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const teleop_bridge_msgs::msg::WarningStatus *>(
...
static size_t _WarningStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WarningStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WarningStatus__callbacks = {
...
static rosidl_message_type_support_t _WarningStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WarningStatus__callbacks,
...
{
  return &teleop_bridge_msgs::msg::typesupport_fastrtps_cpp::_WarningStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_bridge_msgs, msg, WarningStatus)() {
  return &teleop_bridge_msgs::msg::typesupport_fastrtps_cpp::_WarningStatus__handle;
}
