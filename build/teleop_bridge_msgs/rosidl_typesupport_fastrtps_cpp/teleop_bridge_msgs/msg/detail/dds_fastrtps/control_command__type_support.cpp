...
#include "teleop_bridge_msgs/msg/detail/control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const teleop_bridge_msgs::msg::ControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_bridge_msgs::msg::ControlCommand & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_bridge_msgs::msg::ControlCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const teleop_bridge_msgs::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_bridge_msgs::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  return &teleop_bridge_msgs::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_bridge_msgs, msg, ControlCommand)() {
  return &teleop_bridge_msgs::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
