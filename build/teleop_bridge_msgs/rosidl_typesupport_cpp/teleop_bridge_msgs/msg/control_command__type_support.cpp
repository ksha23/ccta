...
static const _ControlCommand_type_support_symbol_names_t _ControlCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_bridge_msgs, msg, ControlCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_bridge_msgs, msg, ControlCommand)),
  }
};
...
{
  return &::teleop_bridge_msgs::msg::rosidl_typesupport_cpp::ControlCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_bridge_msgs, msg, ControlCommand)() {
  return get_message_type_support_handle<teleop_bridge_msgs::msg::ControlCommand>();
}
