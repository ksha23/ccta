...
static const _TrackedVehicle_type_support_symbol_names_t _TrackedVehicle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_bridge_msgs, msg, TrackedVehicle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_bridge_msgs, msg, TrackedVehicle)),
  }
};
...
{
  return &::teleop_bridge_msgs::msg::rosidl_typesupport_cpp::TrackedVehicle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_bridge_msgs, msg, TrackedVehicle)() {
  return get_message_type_support_handle<teleop_bridge_msgs::msg::TrackedVehicle>();
}
