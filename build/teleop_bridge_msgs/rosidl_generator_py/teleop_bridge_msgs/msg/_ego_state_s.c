...
bool teleop_bridge_msgs__msg__ego_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_bridge_msgs.msg._ego_state.EgoState", full_classname_dest, 42) == 0);
  }
  teleop_bridge_msgs__msg__EgoState * ros_message = _ros_message;
  {  // stamp
...
PyObject * teleop_bridge_msgs__msg__ego_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("teleop_bridge_msgs.msg._ego_state");
