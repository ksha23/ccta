...
bool teleop_bridge_msgs__msg__tracked_vehicle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_bridge_msgs.msg._tracked_vehicle.TrackedVehicle", full_classname_dest, 54) == 0);
  }
  teleop_bridge_msgs__msg__TrackedVehicle * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of TrackedVehicle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("teleop_bridge_msgs.msg._tracked_vehicle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackedVehicle");
